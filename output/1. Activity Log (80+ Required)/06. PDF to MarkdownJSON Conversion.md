## Activity Log (80+ Required) — Entry 7: PDF to Markdown/JSON Conversion

**Hours:** 30  
**Date:** 2025-08-07  
**Next Steps:** The next step involves running validation and deduplication on the converted dataset by detecting duplicates via DOI, scoring quality and completeness, and delivering a clean dataset for further processing.  
**Category:** 🧹 Data Preprocessing  
**Summary:**  
The objective is to convert approximately 6,600 UK Biobank PDFs into structured Markdown and JSON while preserving text, tables, and metadata. The process involves a detailed workflow with optimized GPU usage, error handling, and validation to ensure high-quality outputs.  
...
**Entry:** PDF to Markdown/JSON Conversion  
