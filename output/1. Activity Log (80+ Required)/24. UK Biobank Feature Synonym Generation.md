# UK Biobank Feature Synonym Generation
...
2. **Synonym Generation**
    ...
    - Five synonyms per feature generated under strict rules:
        - Common abbreviation (e.g., _BMI_ for body mass index).
        - Formal medical term.
...
5. **Two-Stage Validation**
    ...
    - **Embedding-based**: Biomedical sentence transformers calculate cosine similarity; threshold ≥0.85 required for pass.
...
1. **Qualitative Validation (LLM)**
    ...
    - Example:
        - _“Date I71 first reported (aortic aneurysm and dissection)”_ →`I71 diagnosis date; aortic aneurysm onset; initial dissection documentation; aneurysm detection timing; aortic rupture diagnosis`
            > Verdict: Meets abbreviation, formal, informal, measurement, and regional coverage.
        - _“IGF-1 assay date”_ →`IGF-1 date; insulin-like growth factor measurement date; serum IGF-1 collection; IGF-1 sampling timepoint; IGF-1 assay timing`
