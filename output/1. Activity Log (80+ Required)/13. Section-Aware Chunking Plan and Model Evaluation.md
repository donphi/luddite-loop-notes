...
| Abstract, Summary
                              | abstract
      | First section, <300 words
           |
| Introduction, Background, Literature Review
    | introduction
  | Problem statement, citations heavy
  |
| Methods, Materials, Study Design, Participants
 | methods
       | Procedure description, sample info
  |
| Results, Findings, Outcomes
                    | results
       | Statistical results, figures/tables
 |
